...
// ExperimentTemplateReconciler reconciles a ExperimentTemplate object
type ExperimentTemplateReconciler struct {
	client.Client
...
// the ExperimentTemplate object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.22.1/pkg/reconcile
func (r *ExperimentTemplateReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *ExperimentTemplateReconciler) SetupWithManager(mgr ctrl.Manager) error {
